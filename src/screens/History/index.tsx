      ...
      >
        {
          history.map((item, index) => (
            <Animated.View entering={SlideInRight} exiting={SlideOutRight} layout={LinearTransition.springify()} key={item.id}>
              <Swipeable containerStyle={styles.swipeableContainer} overshootLeft={false}
                leftThreshold={15}
